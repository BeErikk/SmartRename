...
public:
	...
	void RenameHelper(_In_ rename_pairs * renamePairs, _In_ int numPairs, _In_ std::wstring searchTerm, _In_ std::wstring replaceTerm, _In_ uint32_t flags)
	{
	...
	TEST_METHOD(VerifySingleRename)
	{
		...
		RenameHelper(renamePairs, std::size(renamePairs), L"foo", L"bar", DEFAULT_FLAGS);
	}
	...
	TEST_METHOD(VerifyFilesOnlyRename)
	{
		...
		RenameHelper(renamePairs, std::size(renamePairs), L"foo", L"bar", DEFAULT_FLAGS | ExcludeFolders);
	}
	...
	TEST_METHOD(VerifyFoldersOnlyRename)
	{
		...
		RenameHelper(renamePairs, std::size(renamePairs), L"foo", L"bar", DEFAULT_FLAGS | ExcludeFiles);
	}
	...
	TEST_METHOD(VerifyFileNameOnlyRename)
	{
		...
		RenameHelper(renamePairs, std::size(renamePairs), L"foo", L"bar", DEFAULT_FLAGS | NameOnly);
	}
	...
	TEST_METHOD(VerifyFileExtensionOnlyRename)
	{
		...
		RenameHelper(renamePairs, std::size(renamePairs), L"foo", L"bar", DEFAULT_FLAGS | ExtensionOnly);
	}
	...
	TEST_METHOD(VerifySubFoldersRename)
	{
		...
		RenameHelper(renamePairs, std::size(renamePairs), L"foo", L"bar", DEFAULT_FLAGS | ExcludeSubfolders);
	}
};
} // namespace SmartRenameManagerTests
