...
CMockSmartRenameManagerEvents::AddRef()
{
	return InterlockedIncrement(&m_refCount);
}

IFACEMETHODIMP_(ULONG)
CMockSmartRenameManagerEvents::Release()
{
...
IFACEMETHODIMP CMockSmartRenameManagerEvents::OnRegExStarted(_In_ uint32_t threadId)
{
	m_regExStarted = true;
	return S_OK;
}

IFACEMETHODIMP CMockSmartRenameManagerEvents::OnRegExCanceled(_In_ uint32_t threadId)
{
	m_regExCanceled = true;
	return S_OK;
}

IFACEMETHODIMP CMockSmartRenameManagerEvents::OnRegExCompleted(_In_ uint32_t threadId)
{
